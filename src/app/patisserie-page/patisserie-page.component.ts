...
export class PatisseriePageComponent {
  ...
  photoGateau=['assets/chocolatPoire.jpg','assets/praline.jpg','assets/kiwi.jpg','assets/cafe.jpg' ];
  photoPartGateau=['assets/partChocolatPoire.jpg','assets/partPraline.jpg','assets/kiwiPart.jpg','assets/cafePart.jpg'];
  schemaGateau=['assets/dessinChocolatPoireLegende.png'];
  description=[
